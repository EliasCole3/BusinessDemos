namespace FragmentsDemo
{
	internal class DetailsFragment : Fragment
	{
		...
		public static DetailsFragment NewInstance(int selectedItem, string o) //overloaded newInstance method, for making a detailsfragment with the tideitem output, previously put into a textview
		{
			var detailsFragTemp = new DetailsFragment {Arguments = new Bundle()}; 
			detailsFragTemp.Arguments.PutInt("selectedItem", selectedItem);
